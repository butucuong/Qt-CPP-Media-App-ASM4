...
Item {
    ...
    Image {
            ...
            MouseArea {
                ...
                onClicked: {
                   translator.selectLanguage("vi")
                    console.log("Language now is: " +translator.language)
        ...
        Image {
            id: jp_flag
            anchors.right: us_flag.left
            anchors.rightMargin: 10
            anchors.verticalCenter: parent.verticalCenter
            width: 50
            height: 30
            source: "qrc:/Image/japan.png"
            Rectangle{
                width: 50
                height: 30
                anchors.verticalCenter: parent.verticalCenter
                ...
                border.width: 3
                color: "transparent"
                visible: translator.language == "jp"
            }
            MouseArea {
                anchors.fill: parent
                onClicked: {
                   translator.selectLanguage("jp")
                    console.log("Language now is: " +translator.language)
